...
#define XS_QUERY_WEB_TEMPLATE        "INSERT INTO webs (sol_id, pol_id, source_id, capture_date, flow_info, url, relation, method, response, agent, host, content_type, rq_header, rq_body, rq_bd_size, rs_header, rs_body, rs_bd_size) VALUES (%i, %i, %i, "XPCAP_DATE", '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', %i, '%s', '%s', %i)"
...
#define XS_QUERY_FEEDS_XML_TEMPLATE  "INSERT INTO feed_xmls (sol_id, pol_id, source_id, feed_id, capture_date, flow_info, url, rs_header, rs_body, rs_bd_size) VALUES (%i, %i, %i, %lu, "XPCAP_DATE", '%s', '%s', '%s', '%s', '%i')"
