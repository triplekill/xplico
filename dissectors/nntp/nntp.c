        ...
        if (*eol == '\r' || *eol == '\n') {
            ...
            if (msg->st != NNTP_REP_NONE) {
                ...
                case NNTP_CMD_ARTICLE:
                    ...
                    msg->data[dim] = '\0';
                    /* file path and name */
                    sprintf(msg->file_data, "%s/%s/nntp_%lu_%p_%i.eml", ProtTmpDir(), NNTP_TMP_DIR, time(NULL), msg, incr);
                    incr++;
                    /* open */
                ...
                case NNTP_CMD_IHAVE:
                    ...
                    if (msg->post == FALSE) {
                        ...
                        msg->data[0] = '\0';
                        /* file path and name */
                        sprintf(msg->file_data, "%s/%s/nntp_ihave%lu_%p_%i.eml", ProtTmpDir(), NNTP_TMP_DIR, time(NULL), msg, incr);
                        incr++;
                        /* open */
                        msg->fp_data = fopen(msg->file_data, "w");
                        if (msg->fp_data == NULL) {
                ...
                case NNTP_CMD_POST:
                    ...
                    if (msg->post == FALSE) {
                        ...
                        msg->data[0] = '\0';
                        /* file path and name */
                        sprintf(msg->file_data, "%s/%s/nntp_post%lu_%p_%i.eml", ProtTmpDir(), NNTP_TMP_DIR, time(NULL), msg, incr);
                        incr++;
                        /* open */
                        msg->fp_data = fopen(msg->file_data, "w");
                        if (msg->fp_data == NULL) {
